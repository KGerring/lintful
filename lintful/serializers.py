...
__all__ = ['ExternalDependenciesGraph', 'MessageSerializer', 'make_tree_defs',
           'string_tree_defs', 'get_tables', 'MessageSerializer', 'MessageDeSerializer', 'JSONWriter']
import sys # isort:skip
import os # isort:skip
import regex # isort:skip
import re # isort:skip

from lintplus.plugins.reporters import dependencies_graph, get_json_graph
...
from pylint.reporters.ureports.nodes import (BaseLayout, EvaluationSection, Paragraph, Section,
                                             Table, Text, Title, VNode, VerbatimText)
...
class MessageSerializer(JSONEncoder):
	...
	def default(self, o):
		...
		if isinstance(o, OrderedDict):
			return o
		if isinstance(o, ReporterMessage):
			d = o._asdict()
			return self.default(d)
		


class MessageDeSerializer(JSONDecoder):
	_object_hook = None
